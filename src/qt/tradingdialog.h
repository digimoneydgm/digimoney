...
private slots:
    ...
    QString BuyDGM(QString OrderType, double Quantity, double Rate);
    QString SellDGM(QString OrderType, double Quantity, double Rate);
